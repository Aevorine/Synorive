...
Incluye **26 herramientas MCP** para Claude Code.

[English](../../README.md) · [简体中文](README.zh-CN.md) · [Français](README.fr.md) · **Español** · [Русский](README.ru.md) · [العربية](README.ar.md)

[![Descargar](https://img.shields.io/badge/download-v0.1.10-0F4C8C)](https://github.com/Aevorine/Synorive/releases/latest)
...
| | |
|---|---|
| **Instalador de Windows** | [`Synorive-Setup-0.1.10.exe`](https://github.com/Aevorine/Synorive/releases/latest) — con el runtime de Python incluido, **actualización automática dentro de la app** |
| **Windows portable** | [`Synorive-0.1.10-portable.exe`](https://github.com/Aevorine/Synorive/releases/latest) — sin instalación; esta forma no admite actualización automática |
...
| 🔌 | **26 herramientas MCP para Claude Code** — deja que tu agente busque en tu biblioteca y verifique afirmaciones por ti |
...
npm run version:set 0.1.10  # cambia los cuatro de una vez — nunca los edites a mano
...
- **Web** — `web_search` / `research` / `scholar` / `read_url` / `web_engines` / `verify` /
  `unified_search`
- **Búsqueda inversa** — `reverse_image` (dónde más aparece esa imagen en la web),
  `reverse_video` (rastrear un clip hasta su fuente original comparando varios fotogramas clave)
