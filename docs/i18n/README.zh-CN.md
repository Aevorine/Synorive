...
[![下载](https://img.shields.io/badge/download-v0.1.9-0F4C8C)](https://github.com/Aevorine/Synorive/releases/latest)
...
| | |
|---|---|
| **Windows 安装包** | [`Synorive-Setup-0.1.9.exe`](https://github.com/Aevorine/Synorive/releases/latest) —— 自带 Python 运行时，**应用内自动更新** |
| **Windows 便携版** | [`Synorive-0.1.9-portable.exe`](https://github.com/Aevorine/Synorive/releases/latest) —— 免安装；这种形式不支持自动更新 |
...
npm run version:set 0.1.9  # 一条命令改完四处，别手动改
