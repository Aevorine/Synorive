...
[![Download](https://img.shields.io/badge/download-v0.1.11-0F4C8C)](https://github.com/Aevorine/Synorive/releases/latest)
...
| | |
|---|---|
| **Windows installer** | [`Synorive-Setup-0.1.11.exe`](https://github.com/Aevorine/Synorive/releases/latest) — Python runtime bundled, **in-app auto-update** |
| **Windows portable** | [`Synorive-0.1.11-portable.exe`](https://github.com/Aevorine/Synorive/releases/latest) — no install; auto-update not available for this form |
...
npm run version:set 0.1.11  # change all four at once — never edit them by hand
